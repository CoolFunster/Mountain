...
main = do
  ...
  let term_to_run = cleanup $ Call term_to_call (Tuple [Unique initial_console_hash (Literal $ Thing "Console"), Tuple term_args])
  ...
  case term of
    Right (something, _) -> putStrLn $ prettyMountain something
    Left e -> do
